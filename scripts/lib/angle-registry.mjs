...
const ANGLES = {
  ...
  'fire-smoke-damage-restoration': [
    ...
    { titleTemplate: 'Storm and Grass Fire Risk in {city}: How to Protect Your Property', slugPrefix: 'storm-grass-fire-risk-protection', promptFocus: 'Assess fire risk specific to this North Texas city. Cover drought-season grass fires, high winds, lightning strikes during spring storms, defensible space around the property, and local burn bans.' },
  ...
  'mold-remediation': [
    ...
    { titleTemplate: '{city} Rental Properties and Mold: Tenant and Landlord Rights', slugPrefix: 'rental-mold-tenant-landlord-rights', promptFocus: 'Cover the legal rights and responsibilities of tenants and landlords regarding mold. Include Texas Property Code mold disclosure and remediation obligations, tenant remedies, and dispute resolution.' },
  ],
  ...
  'construction-remodeling': [
    ...
    { titleTemplate: 'Choosing a Restoration Contractor in {city}: What to Verify', slugPrefix: 'choosing-restoration-contractor', promptFocus: 'Guide homeowners in vetting a restoration contractor in Texas, where no statewide restoration or GC license exists. Cover verifying bonding and insurance, IICRC and EPA Lead-Safe certification, TDLR licensing for mold work over 25 sq ft, questions to ask, red flags, and local references.' },
